import { selectAllFollowsByUser } from "../repositories/follows.repositories.js"
...
export async function getAllFollowsByUser(req,res){
    const idFollower = res.locals
    try {
        const follows = await selectAllFollowsByUser(idFollower)
